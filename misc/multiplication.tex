...
\begin{document}
    ...
    \begin{tikzpicture}
            ...
            \node[circle,fill=gray,inner sep=1pt,minimum size=3pt] (b) at (-7 / 9 * 8 + \offset, 4 / 9 * 8) {};
            \node [anchor=315, red] at (-7 / 9 * 8 + \offset, 4 / 9 * 8) {$\frac{7}{4}$};
            \draw [purple, line width=1.0pt] (-7 / 9 * 8 + \offset, 4 / 9 * 8) -- (-7 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-7 / 9 * 8 + \offset, 1 / 9 * 8) -- (-6 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-6 / 9 * 8 + \offset, 1 / 9 * 8) -- (-6 / 9 * 8 + \offset, 2 / 9 * 8);
            \draw [orange, line width=1.0pt] (-6 / 9 * 8 + \offset, 2 / 9 * 8) -- (-4 / 9 * 8 + \offset, 2 / 9 * 8);
            \draw [orange, line width=1.0pt] (-4 / 9 * 8 + \offset, 2 / 9 * 8) -- (-4 / 9 * 8 + \offset, 4 / 9 * 8);

            \node[circle,fill=gray,inner sep=1pt,minimum size=3pt] (b) at (-3 / 9 * 8 + \offset, 2 / 9 * 8) {};
            \node [anchor=315, red] at (-3 / 9 * 8 + \offset, 2 / 9 * 8) {$\frac{3}{2}$};
            \draw [purple, line width=1.0pt] (-3 / 9 * 8 + \offset, 2 / 9 * 8) -- (-3 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-3 / 9 * 8 + \offset, 1 / 9 * 8) -- (-2 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-2 / 9 * 8 + \offset, 1 / 9 * 8) -- (-2 / 9 * 8 + \offset, 2 / 9 * 8);

            \node[circle,fill=gray,inner sep=1pt,minimum size=3pt] (b) at (-21 / 9 * 8 + \offset, 8 / 9 * 8) {};
            \node [anchor=315, red] at (-21 / 9 * 8 + \offset, 8 / 9 * 8) {$\frac{21}{8}$};
            \draw [purple, line width=1.0pt] (-21 / 9 * 8 + \offset, 8 / 9 * 8) -- (-21 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-21 / 9 * 8 + \offset, 1 / 9 * 8) -- (-20 / 9 * 8 + \offset, 1 / 9 * 8);
            \draw [orange, line width=1.0pt] (-20 / 9 * 8 + \offset, 1 / 9 * 8) -- (-20 / 9 * 8 + \offset, 4 / 9 * 8);
            \draw [orange, line width=1.0pt] (-20 / 9 * 8 + \offset, 4 / 9 * 8) -- (-16 / 9 * 8 + \offset, 4 / 9 * 8);
            \draw [orange, line width=1.0pt] (-16 / 9 * 8 + \offset, 4 / 9 * 8) -- (-16 / 9 * 8 + \offset, 16 / 9 * 8);

            % \draw [black, line width=1.0pt] (-21 / 9 * 8 + \offset, 14 / 9 * 8) -- (-0 / 9 * 8 + \offset, 0 / 9 * 8);
            % \draw [black, line width=1.0pt] (-21 / 9 * 8 + \offset, 12 / 9 * 8) -- (-0 / 9 * 8 + \offset, 0 / 9 * 8);
            % \draw [black, line width=1.0pt] (-21 / 9 * 8 + \offset, 8 / 9 * 8) -- (-0 / 9 * 8 + \offset, 0 / 9 * 8);
