...
\begin{document}
    \begin{tikzpicture}[x=0.5cm,y=0.5cm,z=0.3cm,>=stealth]
        ...
        \node[fill,circle,inner sep=1.5pt,label={right:$man$}] (q) at (xyz cs:x=1.8, y=-4.0, z=3.0) {};
        \node[fill,circle,inner sep=1.5pt,label={left:$queen$}] (r) at (xyz cs:x=-3.0, y=3.0, z=3.0) {};
        \node[fill,circle,inner sep=1.5pt,label={right:$woman$}] (s) at (xyz cs:x=1.8, y=-4.0, z=9.0) {};
