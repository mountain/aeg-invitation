...
\vspace{10mm}
\vspace{\fill}
\centering{\sihao 苑明理 \\ \wuhao 修订于 2024 年 3 月 19 日}
\end{titlepage}
...
所以，它把词语的同义关系给与几何化表达，赋予了空间维度以语义。
...
\footnote{所有关系运算的可能组合的数量是一种复杂性度量，于是整个讨论隐含了体积或者面积就是这个度量。这个观点在后面计算的时空复杂性里还有所阐发。}
