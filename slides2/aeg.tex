...
\begin{frame}
    ...
    \resizebox{0.5\textwidth}{!}{\includegraphics{../images/knot03}}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{How about mix up additive and multiplicative steps?}
    Question: How about mix additive and multiplicative steps up in one process?
...
\begin{frame}
\frametitle{Regulairty of word2vec}
...
\begin{frame}
    ...
    $\mathfrak{E_1}$ is too rigid, we need other examples.
    Can we find a space that is more flexible?
    \begin{itemize}
...
\begin{frame}
    ...
    Using multiplication as an case study, we should focus on the following questions:
    \begin{itemize}
