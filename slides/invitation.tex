...
\begin{frame}
    \frametitle{Further study: I - a broken clue}
    \begin{figure}[ht]\centering
...
\begin{frame}
    \frametitle{Further study: II - wavefront and zero lines}
    \begin{figure}[ht]\centering
    \resizebox{0.5\textwidth}{!}{\includegraphics{../images/cayley4}}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{Further study: III - new representation}
    \begin{figure}[ht]\centering
    \resizebox{0.5\textwidth}{!}{\includegraphics{../images/cayley4}}
    \end{figure}
\end{frame}
